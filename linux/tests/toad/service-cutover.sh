...
grep -Fq '90-kikimora-unmanaged.conf' "$INSTALLER"
grep -Fq '90-kikimora-unmanaged.conf' "$PACKAGE"
grep -Fq '/etc/NetworkManager/conf.d/90-kikimora-unmanaged.conf' "$PACKAGE"
