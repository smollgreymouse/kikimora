...
Status: **COMPLETE / REVALIDATED ON GREEN CURRENT HEAD**. Endpoint ownership, fail-closed parking, restoration ordering and stale-checkpoint restart semantics are covered by deterministic tests plus fresh route-parking/orchestration privileged evidence.
